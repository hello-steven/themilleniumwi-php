...
$section = "Band";
$pageTitle = $authors["the-millenium"]['nickname'];
...
<section id="BandNav">
    ...
    <h2 class='page-title'>
        ...
        Meet | <?php echo $authors["the-millenium"]["display_name"]; ?>
...
<section id="aboutHeader">
    ...
    <div id="profilePhoto">
        ...
        <img id="author-photo" src="<?php echo $authors["the-millenium"]["img"] ?>" alt="<?php echo $authors["the-millenium"]["display_name"] ?> Photo">
    ...
    <div id="twitter-wrapper">
                    ...
                    <a class="twitter-timeline"
                        width="100%"
                        href="https://twitter.com/<?php echo $authors["the-millenium"]["twitter_id"]; ?>"
                        data-widget-id="505855025675911168"
                        data-screen-name="<?php echo $authors["the-millenium"]["twitter_id"]; ?>"
                        data-show-replies="false"
                        data-tweet-limit="0"
                        data-border-color="#000000">
                        Tweets by @<?php echo $authors["the-millenium"]["twitter_id"]; ?>
                    </a>
